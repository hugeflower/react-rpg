const fr = {
  tutorial: {
    firstStep: [
      ...
      "Les oreillers sont aussi le symbole de la distance émotionnelle entre les deux personnages : les traces des disputes, promesses, espoirs et déceptions qui ont marqué leur vie de couple.",
    ...
    secondStep: [
      ...
      "Répétez pour que chaque joueur puisse définir trois éléments évocateurs.",
    ...
    thirdStep1: [
      ...
      "Quoi que vous décidiez, il s'agit de la fameuse goutte qui fait déborder le vase, le symptôme d'un plus gros bobo, potentiellement le point de non-retour pour ce couple.",
      "Pigez la première carte de la pioche (défaussez les figures) et placez-la face vers" +
      "le haut entre les têtes des deux personnages. Pour la partie en personne, entourez-la d’un rectangle au crayon : il s’agit du premier « oreiller », érigé en barrière.",
    ].join(" "),
    thirdStep2: [
        "Voici un exemple de la première carte pigée et placée sur un oreiller. Vous pouvez prendre cette carte sur le dessus",
        "de la défausse et la glisser jusqu'à l'oreiller vide pour créer votre première situation conflictuelle.\n\n",
    ...
    fourthStep2: [
      "Jouez la scène.\n",
      "Inscrivez quelques mots ou un dessin autour de l’oreiller pour vous rappeler de votre élément déclencheur. Celui-ci",
      "est très frais dans la mémoire des personnages, et n’a pas été réglé avant le coucher : il ne pourra donc pas être effacé durant la phase 3."
    ].join(" "),
    nextButton: "Suivant",
    closeButton: "Fermer",
  },
